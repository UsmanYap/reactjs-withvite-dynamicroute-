                    ...
                    <table className="border">
                      ...
                      <tbody>
                        {angkatan.data[kelas].map((mahasiswa, index) => (
                          <tr key={index}>
                            <td className="border p-1 px-5">{generateNPM(angkatan.tahun_masuk, prodi.kode_prodi, mahasiswa.id)}</td>
                            <td className="border p-1 px-5">{mahasiswa.nama}</td>
                            <td className="border p-1 px-5">{mahasiswa.jenis_kelamin === "L" ? "Laki-laki" : mahasiswa.jenis_kelamin === "P" ? "Perempuan" : "Tidak Diketahui"}</td>
                            <td className="border p-1 px-5">{mahasiswa.alamat}</td>
                            <td className="border p-1 px-5">{mahasiswa.hobi.join(", ")}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
